APPCFG = {
	...
	PIN_CFG: {
		r: {
			iconPath: 'resources/markers/red/Pin_Red_',
			// A css class that define the color to be used for the Desktop carousel and builder organize popup
			cssClass: 'number-red'
		},
		b: {
			iconPath: 'resources/markers/blue/Pin_Blue_',
			cssClass: 'number-blue'
		},
		g: {
			iconPath: 'resources/markers/green/Pin_Green_',
			cssClass: 'number-green'
		},
		p: {
			iconPath: 'resources/markers/purple/Pin_Purple_',
	...
	ICON_CFG: {
		normal: {
			...
			clipRules: "clip: rect(4px, 18px, 26px, 1px); left: 14px; top: 11px; height: 40px; width: 32px;"
		},
		hover: {
			width: 36,
			height: 41,
	...
	// Themes for Three-panel and Integrated layouts
	COLOR_SCHEMES: [
