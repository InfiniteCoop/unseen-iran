...
({
		...
		secondPane: {
			head: "<span class='highlightText'>Mallen</span> innehåller användarvänliga redigeringsverktyg med:",
			list0: "möjlighet att snabbt ändra titlar och bildtexter", 
			list1: "funktioner för att lägga till, ta bort och dölja berättelsepunkter och ändra ordning mellan dem",
		...
		fourthPane: {
			...
			list0: "Berättelsekartor som publiceras av Esris berättelsekartteam",
			list1: "ett urval av mallar som kan laddas ned",
			list2: "guider med bästa praxis", 
			list3: "ett galleri med berättelsekartor som innehåller en växande grupp av berättare"
		}
    })
);
