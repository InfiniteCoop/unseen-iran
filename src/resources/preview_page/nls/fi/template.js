...
({
		...
		secondPane: {
			...
			list0: "Kyky muuttaa nopeasti tiiliä ja selosteita", 
			list1: "Toiminnot tarinan paikkojen lisäämiseksi, poistamiseksi, piilottamiseksi ja järjestyksen muuttamiseksi",
			list2: "Kyky vetää ja tiputtaa kuvakkeita tarinan pisteiden sijaintien muuttamiseksi"
		},
		thirdPane: {
			head: "Jos haluat käyttää isännöidyn kartan kierrosmallia, luo kartta Web-karttojen ArcGIS Online -katseluohjelmassa (kartassa ei tarvitse olla karttatasoja), tallenna se ja napsauta sitten Jaa-painiketta. Valitse Jaa-valintaikkunassa \'Tee web-sovellus\' -vaihtoehto, valitse karttakierrosmalli esiin tulevasta mallivalikoimasta ja suorita toiminto loppuun vaihe vaiheelta. Kun määrität sovelluksen, vuorovaikutteinen editori aukeaa automaattisesti.<br /><br />Jos käyttäjät haluavat laajentaa karttakierrostensa käyttöliittymää tai lisätä uusia toimintoja, toimi seuraavasti:",
