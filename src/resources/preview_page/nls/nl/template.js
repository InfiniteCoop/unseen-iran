...
({
		...
		secondPane: {
			...
			list0: "De mogelijkheid om titels en bijschriften snel te wijzigen", 
			list1: "Functies voor het toevoegen, verwijderen en verbergen van verhaalpunten en voor het wijzigen van de volgorde ervan",
