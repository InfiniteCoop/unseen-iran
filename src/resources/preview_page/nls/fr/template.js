...
({
		...
		secondPane: {
			head: "<span class='highlightText'>Le modèle</span> intègre des outils de mise à jour faciles à utiliser qui incluent :",
			list0: "la possibilité de modifier rapidement les titres et les légendes ;", 
			list1: "des fonctions d\’ajout, de suppression, de masquage et de modification de l\’ordre des points de narration ;",
		...
		fourthPane: {
			...
			list3: "une bibliothèque de cartes de narration qui met en avant les travaux d\’une communauté en pleine évolution."
		}
    })
);
