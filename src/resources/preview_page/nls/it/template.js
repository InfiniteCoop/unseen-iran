...
({
		...
		secondPane: {
			...
			list0: "Funzioni per modificare rapidamente titoli e didascalie", 
			list1: "Funzioni per aggiungere, eliminare, nascondere e modificare l\'ordine di punti della storia",
			list2: "Funzione di trascinamento delle icone per cambiare le posizioni dei punti nella storia"
		},
		thirdPane: {
